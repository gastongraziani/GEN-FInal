...
<div class="container margentop">    
	...
	<form:form class="border border-light p-5" role="form" id="crearRiesgo" action="rieAcc" method="post" modelAttribute="accrie">
	 ...
	 <form:input path="idriesgo" type="hidden" class="form-control" />
	    ...
	    <div class="col-md-12">
	            <div class="md-form">
	                ...
	                <label for="desc" class="textcontrol">Commento</label>
	            </div>
	 ...
	 <br>
	   	<div class="row">
	   	<i class="fas fa-map-marked-alt"></i> <h3 class="text-centro">	Seleziona posizione</h3>
	   		<div class="col-md-12">
			   	<div id="mapubic">
...
var mymap = L.map('mapubic').setView([43.93667, 12.44639], 11);
